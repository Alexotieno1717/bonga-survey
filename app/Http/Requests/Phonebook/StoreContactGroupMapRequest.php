...
class StoreContactGroupMapRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'contact_id' => [
                ...
                Rule::unique('contact_group_maps', 'contact_id')->where(function ($query): void {
                    $query->where('contact_group_id', $this->input('contact_group_id'));
                }),
            ],
            'contact_group_id' => [
                'required',
